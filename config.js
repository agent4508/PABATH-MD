...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'MILTON-MD',
  ...
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY MILTON-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'MILTON',
  sessionName: process.env.SESSION_ID || 'PRABATH-MD~mN8AkLiD#uX0wxOviXPDHPfUVCTN83r8GJl_u7GmS7bDxFltMLTU',
